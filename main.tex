...
\include{requirements_description}
...
%appendices
\begin{appendices}
\include{appendix/usability_test}
\include{appendix/test_case}
\include{appendix/risk}
\include{appendix/examplereport}
\include{appendix/weekly}
\include{appendix/usermanual}
\include{appendix/technicalmanual}
\include{appendix/developmentmanual}
\include{appendix/contacts}
\include{appendix/biztalk}
\include{appendix/mobile_security}
